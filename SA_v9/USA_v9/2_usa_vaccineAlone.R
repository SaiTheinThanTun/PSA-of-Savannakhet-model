...
axis(1, at=seq(-.05,0.05,by=.01), labels = seq(-.05,0.05,by=.01)+round(default.result[,1],2), ylab='% reduction in incidence')
legend(x=.01,y=4,legend=c('lower value of parameter','higher value of parameter'), fill=c('light blue','gold'), cex=1.5)
dev.off()
...
axis(1, at=seq(-.05,0.05,by=.01), labels = seq(-.05,0.05,by=.01)+round(default.result[,2],2), ylab='% reduction in prevalence')
legend(x=-.04,y=3,legend=c('lower value of parameter','higher value of parameter'), fill=c('light blue','gold'), cex=1.5)
dev.off()